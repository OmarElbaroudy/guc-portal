		...
		<UserProvider>
			<Router>
				<Switch>
					...
					<Route exact path="/academicHome/replacementRequests" component = {ViewReplacementRequests}/>
					<Route exact path="/academicHome/submittedRequests" component = {ViewSubmittedRequests}/>
