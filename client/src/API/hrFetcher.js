export class hrFetcher {
  ...
  static async viewMissingHours(token) {
    try {
      const res = await fetch(
        "http://localhost:3000/hr/viewMissingHoursMembers",
        {
          method: "GET",
          headers: {
            Authorization: "",
  ...
  static async viewMissingDays(token) {
    try {
      const res = await fetch(
        "http://localhost:3000/hr/viewMissingDaysMembers",
        {
          method: "GET",
          headers: {
            Authorization: "",
  ...
  static async viewAttendanceRecords(id, token) {
    try {
      const params = { id: id };
      const res = await fetch(
        "http://localhost:3000/hr/viewAttendanceRecords",
        {
          method: "POST",
          body: JSON.stringify(params),
          headers: {
  ...
  static async assignDep(id, department, token) {
    try {
      ...
      const res = await fetch("http://localhost:3000/hr/assignDepartment", {
        method: "POST",
        body: JSON.stringify(params),
        headers: {
          Authorization: "",
  ...
  static async assignHod(id, department, token) {
    try {
      ...
      const res = await fetch("http://localhost:3000/hr/assignHod", {
        method: "POST",
        body: JSON.stringify(params),
        headers: {
          Authorization: "",
