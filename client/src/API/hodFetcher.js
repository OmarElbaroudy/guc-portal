export class hodFetcher {
  static async view(course, token) {
    try {
      ...
      const res = await fetch("/api/HOD/view_staff", {
        method: "POST",
  ...
  static async addCourse(course, staff, token, type) {
    try {
      ...
      const res = await fetch(
        "/api/HOD/assign_course_instructor",
        {
          method: "put",
          body: JSON.stringify(params),
          headers: {
  ...
  static async deleteCourse(course, staff, token) {
    try {
      ...
      const res = await fetch(
        "/api/HOD/delete_course_instructor",
        {
          method: "put",
          body: JSON.stringify(params),
          headers: {
  ...
  static async updateCourse(course, oldStaff, newStaff, token) {
    try {
      ...
      const res = await fetch(
        "/api/HOD/update_course_instructor",
        {
          method: "put",
          body: JSON.stringify(params),
          headers: {
  ...
  static async viewRequests(token) {
    try {
      const res = await fetch("/api/HOD/view_requests", {
        method: "get",
        headers: {
          Authorization: "",
          "auth-token": token,
  ...
  static async acceptRequests(id, token, message) {
    try {
      ...
      const res = await fetch("/api/HOD/accept_requests", {
        method: "put",
        body: JSON.stringify(params),
        headers: {
          Authorization: "",
  ...
  static async rejectRequests(id, token, message) {
    try {
      const params = { _id: id, comment: message };
      const res = await fetch("/api/HOD/reject_requests", {
        method: "put",
        body: JSON.stringify(params),
        headers: {
          Authorization: "",
  ...
  static async viewDayOff(id, token) {
    try {
      const params = { id: id };
      const res = await fetch("/api/HOD/view_day_off", {
        method: "post",
        body: JSON.stringify(params),
        headers: {
          Authorization: "",
